...
function showPopupheat(d, x, y) {
  ...
  popup
    .append("text")
    .text("id: " + d.id + " Time: " + d.Timestamp.split(" ")[1]);
}
  ...
  selectElement.addEventListener("change", function (event) {
    ...
    if (choosenID != 0) {
      document.getElementById("car_id").innerHTML =
        " " + carData[choosenID - 1].CarID;
      document.getElementById("car_name").innerHTML =
        " " +
        carData[choosenID - 1].FirstName +
        " " +
        carData[choosenID - 1].LastName;

      document.getElementById("car_type").innerHTML =
        " " + carData[choosenID - 1].CurrentEmploymentType;
      document.getElementById("car_title").innerHTML =
        " " + carData[choosenID - 1].CurrentEmploymentTitle;
    } else {
      document.getElementById("car_id").innerHTML = " ";
      document.getElementById("car_name").innerHTML = "";
...
function changeCarsCheckbox() {
  var checkBox = document.getElementById("cars_checkbox");
